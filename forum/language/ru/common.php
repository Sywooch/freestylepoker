...
$lang = array_merge($lang, array(
	...
	'FMNU_EDIT_MY'						=> 'редактировать',
	'FMNUADMIN'							=> 'Панель администратора',
	'FMNUABOUT'							=> 'О нас',
	'FMNUFPP'							=> 'FPP',
	'FMNUREFFERAL'						=> 'Реферальная программа',
	'FMNUVIDEO'							=> 'Видео',
	'FMNUARTICLES'						=> 'Статьи',
	'FMNUGOLD'						    => 'Золотой фонд',
	'FMNUTRAINS'						=> 'Тренировки',
	'FMNUPOKERROOM'						=> 'Покер-румы',
	'RESIZELESS'						=> 'меньше',
	'RESIZEMORE'						=> 'больше',
	'TOPICSTARTER'						=> 'Начал тему',
	'USERRATING'						=> 'Рейтинг пользователя',
	'RATING'							=> 'Рейтинг',
	'FMNUCOPYLINK'						=> 'Скопировать ссылку на это сообщение',

	'QUOTE_FULL'						=> 'цитировать',
	'QUOTE_SEL'							=> 'выделенное',
	'QUOTE_AUTHOR'						=> 'только ник',
	'QUOTE_ANSW'						=> 'ответить',
	...
	'UNWATCH_TOPIC'		=> 'Уверены, что хотите отписатся от этой темы?',
