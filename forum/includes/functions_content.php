...
function bbcode_nl2br($text)
{
	...
	// ¬ŒŒ¡Ÿ≈“Œ ﬂ ≈Ã” √Œ¬Œ–»À ◊“Œ Õ¿ƒŒ ¡€ ÕŒ–Ã¿À‹ÕŒ ƒ≈À¿“‹ Œ¡–¿¡Œ“ ” BB “≈√Œ¬ :TROLL:
		$str_search = Array(
			'#\[color=&quot;(\#[0-9a-zA-Z]+?)&quot;\](.+?)\[\/color\]#is',
			'#\[color=&quot;([0-9a-zA-Z]+?)&quot;\](.+?)\[\/color\]#is',
			'#\[converted_hand\](.+?)\[\/converted_hand\]#is',
			'#\[spoil\](.+?)\[\/spoil\]#is',
			'#\[hand_history\](.+?)\[\/hand_history\]#is',
			'#\[url=&quot;http:\/\/([\w|\)|\(|\.|\-|=|\?|\&|;|\/|\%|_]*?)\](.+?)\[\/url\]#is'
		);
		...
		$str_replace = Array(
			...
			"\\1",
			"\\1",
			"<a title=\"http://\\1\" target=\"_blank\" href=\"http://\\1\">\\2</a>'"
		);
