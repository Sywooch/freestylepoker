...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'nill\users\controllers\frontend';
    ...
    public function init()
    {
        ...
        if ($this->isBackend === true) {
            $this->setViewPath('@nill/users/views/backend');
        } else {
            $this->setViewPath('@nill/users/views/frontend');
        }
    }
    ...
    public function getMail()
    {
        if ($this->_mail === null) {
            ...
            $this->_mail->htmlLayout = '@nill/users/mails/layouts/html';
            $this->_mail->textLayout = '@nill/users/mails/layouts/text';
            $this->_mail->viewPath = '@nill/users/mails/views';
