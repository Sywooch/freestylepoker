...
{
    public $controllerNamespace = 'nill\slider\controllers\backend';

    /**
     * @var string Image path
     */
    public $imagePath = '@statics/web/slider/images/';

    /**
     * @var string Images temporary path
     */
    public $imagesTempPath = '@statics/temp/slider/images/';

    /**
     * @var string Image URL
     */
    public $imageUrl = '/statics/slider/images';
    ...
    public function init()
    {
        ...
        if ($this->getIsBackend() === true) {
            $this->setViewPath('@nill/slider/views/backend');
        } else {
            $this->setViewPath('@nill/slider/views/frontend');
        }
    }
