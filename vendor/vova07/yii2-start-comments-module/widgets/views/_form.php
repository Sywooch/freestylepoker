...
<?= Html::beginForm(['/comments/default/create'], 'POST', ['class' => 'form-horizontal', 'data-comment' => 'form', 'data-comment-action' => 'create']) ?>
    <div class="form-group" data-comment="form-group">
        <div class="col-sm-12">
            <?= Html::activeTextarea($model, 'content', ['class' => 'form-control', 'placeholder' => Module::t('comments', 'TEXT_MESSAGE')]) ?>
...
<?= Html::submitButton(Module::t('comments', 'FRONTEND_WIDGET_COMMENTS_FORM_SUBMIT'), ['class' => 'btn btn-primary btn_comment']); ?>
<?= Html::endForm(); ?>